...
describe "IntervalTree::InclusiveTree" do
  ...
  describe '#center' do
    describe 'given [(1..4),]' do
      it 'returns 1' do
        itvs = [(1..4),]
        t = IntervalTree::InclusiveTree.new([])
  ...
  describe '.new' do
     describe 'given [(1..4),]' do
       it 'returns an Tree objects' do
         itvs = [(1..4),]
         IntervalTree::InclusiveTree.new(itvs).must_be_instance_of IntervalTree::InclusiveTree
      end
    end
    ...
    describe 'given [(1..4),(2..5), (3..6)]' do
      it 'returns ret.top_node.x_centeran == 2 ' do
        itvs = [(1..4),(2..5), (3..6)]
        tree = IntervalTree::InclusiveTree.new(itvs)
  ...
  describe '#search' do
    ...
    describe 'given [(1..4), (2..5)] and a point query "3"' do
      it 'returns [(1..4), (2..5)]' do
        itvs = [(1..4), (2..5),]
        results = IntervalTree::InclusiveTree.new(itvs).search(3)
    ...
    describe 'given [(0..7), (1..4), (2..5)] and a query by (1...4)' do
      it 'returns [(0..7), (1..4), (2..5)]' do
        itvs = [(0..7), (1..4), (2..5)]
        results = IntervalTree::InclusiveTree.new(itvs).search(1...4)
        results.must_equal itvs
      end
    end
    ...
    describe 'given [(1..2), (3..4)] and a query by 3' do
      it 'returns [(3..4)]' do
        results = IntervalTree::InclusiveTree.new([(1..2), (3..4)]).search(3..8)
    ...
    describe 'given [(1..3), (3..5), (4..8)] and a query by (3..5)' do
      it 'returns [(3..5), (4..8)]' do
        itvs = [(1..2), (3..4), (4..7)]
        results = IntervalTree::InclusiveTree.new(itvs).search(3..5)
    ...
    describe 'given [(1..1), (4..5), (7..7), (9..10), (3..8), (2..3), (4..4), (8..8), (6..6), (13..13)] and a query by (7..7)' do
      it 'returns [(7..7)]' do
        ...
        results = IntervalTree::InclusiveTree.new(itvs).search(7..7)
    ...
    describe 'given [(1..1), (4..5), (7..7), (9..10), (3..8), (2..3), (4..4), (8..8), (6..6), (13..13)] and a query by (3..8)' do
      it 'returns [ 2..3, 3..8, 4..4, 4..5, 6..6, 7..7, 8..8 ]' do
        itvs = [(1..1), (4..5), (7..7), (9..10), (3..8), (2..3), (4..4), (8..8), (6..6), (13..13)]
        results = IntervalTree::InclusiveTree.new(itvs).search(3..8)
